...
#define SOC_MEMORY_SIZE (256 * 1024 * 1024)  /* 256 MB simulated memory */
#define SOC_MAX_BUFFERS 128                   /* Maximum number of memory buffers */
...
/* SoC Memory management functions */
